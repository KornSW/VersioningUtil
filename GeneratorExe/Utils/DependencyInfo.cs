...
namespace Versioning {
  ...
  public class DependencyInfo {
    ...
    public DependencyInfo(string targetPackageId, string targetPackageVersionConstraint, string dedicatedToTargetFramework = null) {
      ...
      this.DedicatedToTargetFramework = dedicatedToTargetFramework;
    }
